...
\begin{soln}\begin{equation*}
	m_1 u_1 + \cancelto{0}{m_2 u_2} = (m_1+m_2)v \RA 3.0\times6.0 = (3.0+1.0)\times v \RA v=4.5 \mps 
\end{equation*}
\end{soln}
\begin{marginfigure}
	\vspace*{6pt}
...
the two spheres simply exchange velocities during the collision, as shown in diagram \end{soln}\marginnote{If two objects of equal mass collide elastically with one another, one can actually show that their velocities would exchange regardless of their initial velocities.}
