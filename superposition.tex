...
\end{figure*}
\vspace{2cm}
Note: longitudinal waves are often represented by transverse diagrams:
\vspace{1cm}
...
\cmt phase difference can be related to path difference by: \begin{empheq}[box=\tcbhighmath]{equation*}{ \frac{\Delta \phi}{2\pi} = \frac{\Delta L}{\lambda} = \frac{\Delta t}{T} } \end{empheq}
