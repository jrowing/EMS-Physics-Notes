...
\cmt Hooke's law can be summarised by the equation: \begin{empheq}[box=\tcbhighmath]{equation*}{F=kx}\end{empheq}
...
\begin{soln}\begin{equation*}
	\fnet = F - mg = kx - mg = ma \RA a = \frac{kx-mg}{m} = \frac{270\times5.0\times10^{-2} - 1.2 \times 9.81}{1.2} \approx 1.44 \mpss 
\end{equation*}
\end{soln}
...
\begin{soln} elastic potential energy in spring transforms into kinetic energy of trolley
\begin{equation*}
...
% \begin{ilight}
% 	\centering ratio of stress to strain of a material is called the \keypoint{Young modulus}\index{Young modulus}:\begin{equation*} 
%  \eqbox{E = \frac{\sigma}{\epsilon} \end{equation*}
% \end{ilight}
...
\begin{soln}\begin{equation*}
	E = \frac{\sigma}{\epsilon} = \frac{\sfrac{F}{A}}{\sfrac{x}{L}} = \frac{FL}{Ax} = \frac{200 \times 1.5}{\pi \times (0.30\times10^{-3})^2 \times 5.0 \times 10^{-3}} \RA E \approx 2.1 \times 10^{11} \text{ Pa} 
\end{equation*}
\end{soln}
...
\begin{soln} \begin{equation*}
	E = \frac{FL}{Ax} \RA F = \frac{EAx}{L} = \frac{2.1\times10^{11} \times (0.15\times0.15) \times2.0\times10^{-3}}{0.30} \RA F \approx 3.15 \times 10^7 \text{ N} 
\end{equation*}
\end{soln}
...
\begin{soln}\begin{equation*}
	E = \frac{FL}{Ax} \RA A = \frac{1}{4}\pi d^2 = \frac{FL}{Ex} \RA d^2 \propto \frac{1}{E} \RA \frac{d_A}{d_B} = \sqrt{\frac{E_B}{{E_A}}} = \frac{1}{\sqrt{2}} 
\end{equation*}
\end{soln}
...
\begin{equation*}
E = \frac{FL}{Ax} \RA x = \frac{FL}{AE} = \frac{mgL}{\pi r^2 E} = \frac{\rho V g L}{\pi r^2 E} \RA x \propto \frac{VL}{r^2} \propto \frac{l^3 l}{l^2} \propto l^2 \RA \frac{x_\text{full}}{x_\text{model}} = 10^2 = 100 
\end{equation*}
\end{soln}
