...
so mass of nucleus is determined by total number of protons and neutrons: \begin{empheq}[box=\tcbhighmath]{equation*}{m = A\text{u}}\end{empheq}
...
\cmt using this notation, protons, neutrons and electrons can be represented by: \begin{empheq}[box=\tcbhighmath]{equation*}{^1_1\text{p}} \hspace{1cm}{^1_0\text{n}}\hspace{1cm}{^{\phantom{-}0}_{-1}\text{e}}\end{empheq}
